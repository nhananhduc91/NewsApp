...
const fetchNews = async function () {
  try {
    ...
    if (userSettings.length === 0) {
      result = await fetch(`https://newsapi.org/v2/top-headlines?country=us&pageSize=${resultsPerPage}&page=${curPage}&apiKey=84f22bc64fb744b980a2474ebc3713ed`);
    } else {
      result = await fetch(`https://newsapi.org/v2/top-headlines?country=us&pageSize=${userSettings[0].newsPerPage}&category=${userSettings[0].newsCategory}&page=${curPage}&apiKey=84f22bc64fb744b980a2474ebc3713ed`);
    }
